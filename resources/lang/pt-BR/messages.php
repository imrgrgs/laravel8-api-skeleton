...
return [
    ...
    'retrieved' => ':model obtido com sucesso.',
    ...
    'cant_register_user_with_role_greater' => 'Não pode registrar usuário com funções diferentes das suas funções. Rejeitadas: :not_allowed',
